...
int main()
{
    std::cout << isSquare(-1) << std::endl;
    std::cout << isSquare(3) << std::endl;
    std::cout << isSquare(4) << std::endl;
    std::cout << isSquare(25) << std::endl;
    std::cout << isSquare(26) << std::endl;
    std::cout << isSquare(676) << std::endl;
